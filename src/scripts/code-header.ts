function addCodeHeader() {
  ...
  codeBlocks.forEach((block) => {
    ...
    toolbar.className = 'code-toolbar flex justify-between items-center px-4 py-2 text-xs uppercase';
    ...
    if (!shouldHideCopyButton) {
      ...
      button.className = 'code-copy allowed copy-button rounded px-2 py-1 text-xs';
